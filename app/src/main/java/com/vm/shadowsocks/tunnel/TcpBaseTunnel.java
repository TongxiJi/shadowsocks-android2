...
public abstract class TcpBaseTunnel {
    ...
    private TcpBaseTunnel m_BrotherTunnel;
    private boolean m_Disposed;
    private InetSocketAddress m_ServerEP;
    private InetSocketAddress m_DestAddress;

    public TcpBaseTunnel(SocketChannel innerChannel, Selector selector) {
        this.m_InnerChannel = innerChannel;
        this.m_Selector = selector;
        SessionCount++;
    }

    public TcpBaseTunnel(InetSocketAddress serverAddress, Selector selector) throws IOException {
    ...
    public void setBrotherTunnel(TcpBaseTunnel brotherTunnel) {
